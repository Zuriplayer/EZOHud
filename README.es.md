...
- Capas opcionales de estado integradas en la barra de Salud. Utilizan los datos visuales de atributos nativos de ESO para escudos de daño, trauma y bloqueo de curación, sin deducir estados mediante nombres o IDs de habilidades; una previsualización de cinco segundos en LAM permite comprobar las tres capas sin necesitar un estado de combate activo.
...
- Marco de Compañero Personalizado para el compañero activo local con nombre, barra de salud inspirada en la nativa, formatos numéricos de salud opcionales, modos de visibilidad solo/grupo, posición guardada, escala, ancho, opacidad y ocultación opcional del marco local de compañero que ESO usa estando solo sin modificar las filas nativas de compañero de grupo o banda.
...
- Panel Informativo de Divisas con selección individual de Oro, Puntos de Alianza, Fortuna Archivística, Fragmentos Imperiales, Piedras de Tel Var, Puntos de Tomo, Barras de Comercio, Cristales de Transmutación, Llaves de los Indomables, Vales de Escritura y Coronas. Admite orientación horizontal o vertical, presentación de texto/icono/texto más icono, movimiento temporal con el ratón, detalles al pasar el cursor y ocultación opcional durante el combate.
- Los iconos de divisas usan las texturas a color de teclado de ESO en ambos modos de entrada, con las texturas de mando de ESO como alternativa si falta alguna de teclado.
...
- Las ventanas de Barras de Habilidades Personalizadas, Historial de Botín personalizado, Panel Informativo de Divisas, Tracker de Misiones personalizado, Búsqueda de Grupo personalizada, Marco de Compañero Personalizado y Sinergia personalizada quedan restringidas a escenas HUD para que los paneles nativos de menú sigan siendo accesibles.
...
Cuando EZOCore está activo, el panel completo se dibuja dentro de `Ajustes > EZO` y no se duplica en la lista estándar de ajustes de Addons. Las superficies de Atributos, Ultimate, Barras de Habilidades Personalizadas, Execute, Crux, Panel Informativo de Divisas, Tracker de Misiones personalizado, Sinergia personalizada, Búsqueda de Grupo personalizada, Marco de Compañero Personalizado, Historial de Botín personalizado y Ajustes de Interfaz Nativa se registran por separado en el modo compartido de disposición de interfaz. Sin EZOCore, las mismas opciones y controles locales temporales de movimiento siguen disponibles mediante el panel normal de LibAddonMenu.
...
- HUD de atributos: activar barras personalizadas, ocultar automáticamente las barras vanilla al activar el HUD, elegir el modelo de barras, bloquear opcionalmente las tres barras al mismo Tamaño y anchura máxima exacta, integrar en Salud los estados nativos de escudo/trauma/bloqueo de curación, habilitar movimiento del HUD, definir alpha fuera de combate y ajustar tamaño hasta 750, color y umbral de aviso por recurso.
...
- Marco de Compañero Personalizado: activar un marco propio para el compañero activo local, ocultar opcionalmente el marco local nativo que ESO usa estando solo, elegir visibilidad en solitario/grupo, mover el marco, seleccionar valores de salud ocultos/porcentaje/actual-máxima/ambos y ajustar escala, ancho y opacidad. Las filas de compañero de grupo y banda permanecen nativas y sin cambios.
...
- Panel Informativo de Divisas: activar el panel, ocultarlo opcionalmente durante el combate, elegir orientación horizontal o vertical, elegir texto/icono/texto más icono, elegir un único modo común de saldo jugador/jugador más banco, moverlo temporalmente, ajustar escala y separación y activar divisas una a una. En modo jugador más banco, los dos saldos se muestran separados como `jugador / banco`, nunca sumados. El panel comprueba la capacidad `CanCurrencyBeStoredInLocation` de ESO para cada divisa: el modo común solo se aplica cuando admite jugador y banco; las divisas solo de banco o de cuenta mantienen la ubicación definida por ESO. Pasa el ratón por las entradas para ver saldos detallados y la descripción de la divisa de ESO cuando esté disponible.
- Debug: activar registro de debug y, opcionalmente, reflejar la salida de debug en el chat.

## Límites de Seguridad

- Toda superficie movible de EZOhud usa exclusivamente el botón derecho cuando
  su modo de movimiento está activo. Las acciones del clic izquierdo no cambian;
  los controles nativos y los marcadores fijos o ligados a unidades no se
  convierten en superficies libres.
...
- Los indicadores de execute, ultimate, barras de habilidades personalizadas, recursos y Crux son solo informativos. El ciclo retrasado de Asalto Subterráneo usa un contador previsto de seis segundos cuando ESO no entrega un temporizador de slot completo; no altera el lanzamiento ni la rotación.
...
- El Marco de Compañero Personalizado es solo informativo y sigue al compañero activo del jugador local. Su opción de ocultación nativa afecta únicamente al marco local de compañero que ESO usa estando solo; no oculta ni sustituye las filas de compañero de los marcos nativos de grupo o banda.
- Las superficies de Barras de Habilidades Personalizadas, Historial de Botín personalizado, Tracker de Misiones personalizado, Búsqueda de Grupo personalizada, Marco de Compañero Personalizado y Sinergia personalizada se ocultan fuera de las escenas HUD normales, y el Historial de Botín personalizado solo captura el mouse mientras su modo de movimiento está activo.
- El Panel Informativo de Divisas se oculta fuera de las escenas HUD normales y puede ocultarse opcionalmente durante el combate. Su modo común de saldo está limitado a las divisas que ESO informa como almacenables tanto en jugador como en banco; las coronas y otras divisas solo de cuenta no pasan a ser bancarias por esta opción. Sus detalles emergentes se colocan encima o debajo de la fila para mantener visible el icono y el valor; requieren ratón, no añaden navegación de teclado/mando ni cambian los controles nativos de divisas.
- Los valores de banco y cuenta están limitados a los datos de divisa que ESO expone y mantiene en caché. El panel se actualiza con eventos de divisa/banco y al abrir el banco, pero no puede forzar una consulta del saldo en servidor mientras el banco está cerrado.
...
- Activar el Panel Informativo de Divisas, probar la opción de ocultación en combate, cada ubicación, cambiar entre horizontal/vertical y texto/icono/texto más icono, pasar el ratón por cada entrada, moverlo, recargar la interfaz, abrir/cerrar un banco y repetir las comprobaciones visuales con teclado y mando preferido. Las comprobaciones estáticas no sustituyen estas pruebas dentro de ESO.
- Activar y desactivar el cursor del ratón con el Panel Informativo de Divisas visible; comprobar que sus iconos conservan el color en ambos estados.
...
- Probar el Marco de Compañero Personalizado con un compañero activo estando solo, tras entrar y salir de un grupo, al retirar o cambiar de compañero, después de la muerte/reanimación del compañero y tras `/reloadui`. Confirmar que la salud se actualiza inmediatamente, todos los formatos numéricos caben, movimiento/escala/ancho/opacidad persisten, el marco desaparece fuera de escenas HUD, el marco nativo en solitario se restaura cuando corresponde y las filas nativas de compañero de grupo/banda nunca se ocultan.
...
- Probar las capas de estado de Salud con un escudo de daño activo, una mecánica de trauma y bloqueo de curación. Confirmar que los estados azul suave, violeta y rojo oscuro se actualizan inmediatamente, sobreviven a `/reloadui` si el estado nativo continúa activo, permanecen dentro de Salud en ambos modelos y desaparecen cuando termina el estado correspondiente o se desactiva la opción.
