...
- Barras de Habilidades Personalizadas que muestran copias visuales movibles de las barras principal y secundaria, con una opción para ocultar la barra de habilidades nativa del HUD de ESO mientras las barras personalizadas están visibles.
...
- Barras de Habilidades Personalizadas horizontales o verticales con iconos genéricos por categoría de arma, ocultación del icono de arma inactiva, orden vertical invertido para habilidades pensando en mando con ultimate abajo, animación visual al usar slots, temporizadores nativos opcionales de efectos de slot y acumulaciones que mantienen totalmente visibles los slots temporizados aunque estén en la barra no activa, umbral proporcional configurable de aviso de temporizador, etiquetas nativas de tecla escalables, color compartido configurable para la barra de temporizador, tamaño de iconos hasta 96 px, separación, alpha de barra no activa, alpha de slot opacado, texto de poder/coste de ultimate con opacidad reducida si no está listo y opciones globales guardadas para opacar arma, habilidades 1-5 y ultimate.
...
- Las Barras de Habilidades Personalizadas son solo informativas. Cuando se solicita, pueden ocultar visualmente la barra de habilidades nativa del HUD de ESO, pero no lanzan habilidades, no cambian armas, no usan objetos del slot rápido, no activan keybinds ni automatizan rotaciones. Los temporizadores de efectos, acumulaciones y cooldowns del slot rápido solo se muestran cuando ESO expone datos nativos de slot; los slots sin datos nativos de temporizador quedan en blanco. Las etiquetas de tecla son solo visuales y siguen los atajos actuales de ESO cuando están activadas.
...
- Probar Barras de Habilidades Personalizadas con modos principal, secundaria, ambas, solo activa, horizontal y vertical. Confirmar que el toggle maestro activa inmediatamente los ajustes dependientes tanto en Ajustes > EZO como en el panel LAM independiente sin dejarlos visualmente en gris, el modo vertical coloca arriba el slot de acción más alto y mantiene ultimate abajo, los iconos de arma cambian al cambiar de arma, solo el icono de arma activa queda visible con marco violeta, los iconos de arma inactiva desaparecen, el resaltado de barra activa sigue los cambios de barra, los slots usados parpadean al activarse, los slots opacados se aplican a ambas barras salvo cuando un temporizador nativo está activo, los temporizadores nativos y acumulaciones siguen los datos de efecto de slot de ESO, los slots de habilidad de la barra no activa con temporizador activo permanecen totalmente visibles, el color compartido de la barra de temporizador se aplica a todos los slots, el umbral de aviso cambia a tinte de aviso los temporizadores con poco tiempo restante, los modos de etiquetas muestran las teclas de teclado/mando esperadas y escalan con el tamaño de icono, las etiquetas de mando quedan algo más pequeñas que las de teclado, el icono de slot rápido activo se actualiza y se mueve de forma independiente, muestra contador de objetos cuando está listo, cambia a etiqueta de tiempo restante durante el cooldown de poción/bebida y se rellena verticalmente hasta recuperar visibilidad completa, ultimate muestra actual/coste y se opaca antes de estar listo, la barra nativa se oculta/restaura con el nuevo ajuste y ambas barras personalizadas se pueden arrastrar de forma independiente en ambos ejes.
